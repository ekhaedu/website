...
export default function Home() {
  return (
    <div
      className="min-h-screen bg-white text-[var(--color-foreground)]"
      style={{ fontFamily: "var(--font-body)" }}
    >
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-trust-blue/90 backdrop-blur-md border-b border-slate-100 shadow-sm">
