      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-20">
          <div className="lg:w-1/3">
            <h2 className="text-6xl font-bold text-foreground uppercase leading-none sticky top-32">
              What
              <br />
          ...
          <div className="lg:w-2/3">
            <div className="border-t border-slate-200">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className={`p-8 transition-all duration-500 ${activeFeature === index ? "py-12" : "py-8"}`}
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-6">
                        ...
                        <h3
                          className={`text-3xl font-medium uppercase transition-colors ${activeFeature === index ? "text-foreground" : "text-slate-500"}`}
                        >
                          {feature.title}
                        </h3>
                      </div>
                    ...
                    <div
                      className={`overflow-hidden transition-all duration-500 ${activeFeature === index ? "max-h-48 opacity-100" : "max-h-0 opacity-0"}`}
                    >
                      <div className="pl-12 max-w-xl">
                        <h4 className="text-neon-purple font-mono text-sm mb-2 uppercase tracking-wider">
                          {feature.headline}
                        </h4>
